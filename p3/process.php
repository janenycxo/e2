...
if ($player1choice == 'Labrador Retriever' and $player2choice == 'German Shepherd') {
    $winner = 'Sorry! You did not answer correctly. Please visit <a href="https://www.akc.org"> AKC </a> 
for more interesting facts about dog breeds.';
} elseif ($player1choice =='Labrador Retriever' and $player2choice == 'Labrador Retriever') {
    $winner = 'You won! Visit <a href="https://www.akc.org"> AKC </a> for more interesting facts about 
dog breeds.';
